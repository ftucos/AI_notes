...
0  
\end{bmatrix}}  
$$ and $$\color{red}{\boldsymbol{j}} = \color{red}{\begin{bmatrix}
0 \\
1
\end{bmatrix}}$$
Take a vector $\boldsymbol{\vec{v}}$ with $$\begin{bmatrix}
\color{purple}{x} \\
\color{orange}{y}
\end{bmatrix}$$ coords
...
\color{purple}{2} \\
\color{orange}{-1}
\end{bmatrix}$$ can be expressed as a linear combination of the coord system $$\boldsymbol{\vec{v}}= \color{purple}{2}\color{blue}{\boldsymbol{i}} + \color{orange}{(-1)}\color{red}{\boldsymbol{j}} = \color{purple}{2} \color{blue}{\begin{bmatrix}
1 \\
0
...
\color{orange}{-1}
\end{bmatrix}$$ 
For convenience, the reference coordinate system is usually indicate as a 2X2 matrix:$$\begin{bmatrix}
\color{blue}{1}&\color{red}{0} \\
\color{blue}{0}&\color{red}{1}
\end{bmatrix}$$ In this case this is an identity matrix.
$$\boldsymbol{\vec{v}}= \begin{bmatrix}
\color{blue}{1}&\color{red}{0} \\ 
\color{blue}{0}&\color{red}{1}
\end{bmatrix}\begin{bmatrix}
...
E.g.
$$\color{blue}{\boldsymbol{\hat{i}}} = \color{blue}{\begin{bmatrix}
2 \\
0
\end{bmatrix}}$ and $\color{red}{\boldsymbol{\hat{j}}} = \color{red}{\begin{bmatrix}
1 \\
3
\end{bmatrix}}$$
...
\end{bmatrix}$$
Consequently $$\boldsymbol{\vec{v}}= \color{purple}{2}\color{blue}{\boldsymbol{\hat{i}}} + \color{orange}{(-1)}\color{red}{\boldsymbol{\hat{j}}} = \begin{bmatrix}
\color{blue}{2}&\color{red}{1} \\
\color{blue}{0}&\color{red}{3}
\end{bmatrix}\begin{bmatrix}
\color{purple}{2} \\
...
\color{blue}{x}  + 3\color{red}{y} + 0\color{green}{z}
 &= 2
\end{aligned}$$       $$\overbrace{\begin{bmatrix}
2 & 5 & 3\\
4 & 0 & 8\\
1 & 3 & 0
\end{bmatrix}}^{A}
